...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4"><div class="card p-3"><h1>Por que cuidar do sono é importante?</h1><br>
                
             O sono é essencial para manter o corpo e a mente saudáveis. Quando não dormimos o suficiente, a concentração e a memória são afetadas, tornando tarefas diárias mais difíceis. 
             ...
             Para evitar esses danos, é fundamental tratar distúrbios como insônia e apneia, além de criar uma rotina de sono regular, garantindo um descanso de qualidade e mais saúde no dia a dia.

            </div></div>

            <div class="col-md-4"><div class="card p-3"><h1>O colchão e o travesseiro influenciam no sono?</h1><br>
            
             O colchão e o travesseiro influenciam diretamente na qualidade do sono, pois afetam o conforto e o suporte da coluna. 
             ...
             Além disso, a vida útil desses itens deve ser considerada: colchões devem ser trocados a cada 7 a 10 anos e travesseiros a cada 1 a 2 anos.

        </div></div>
            
            <div class="col-md-4"><div class="card p-3"><h1>Quais hábitos que podem influenciar negativamente no seu sono?</h1><br>
           <strong>1.</strong> Malhar na hora errada: Evite fazer exercícios antes de dormir, pois eles podem deixar você mais agitado e dificultar o sono.<br>
           <strong>2.</strong> Luzes ao dormir: Evite celular, TV ou qualquer luz no ambiente. O ideal é um quarto escuro para melhorar a qualidade do sono.<br>
           <strong>3.</strong> Comer e beber em excesso à noite: Evite alimentos pesados e bebidas em excesso, pois podem atrapalhar a digestão e interromper seu sono.<br>
            </div></div>
