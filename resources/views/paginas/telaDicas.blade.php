...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-4"><div class="card p-3"><h1>Mantenha uma rotina</h1> <br>
            ...
            Criar uma rotina não significa rigidez extrema, mas sim estabelecer hábitos consistentes que facilitem o equilíbrio entre trabalho, lazer e descanso.</div></div>


            <div class="col-md-4"><div class="card p-3"><h1>Evite telas antes de dormir</h1><br>
            ...
            <div class="col-md-4"><div class="card p-3"><h1>Crie um ambiente confortável</h1><br> 
